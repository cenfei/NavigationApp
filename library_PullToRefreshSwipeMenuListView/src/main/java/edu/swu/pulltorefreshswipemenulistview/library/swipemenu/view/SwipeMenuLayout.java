...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public boolean onSwipe(MotionEvent event,ViewPager viewPager) {
    ...
    private void swipe(int dis,ViewPager viewPager) {
    ...
    public void computeScroll() {
        if (state == STATE_OPEN) {
            if (mOpenScroller.computeScrollOffset()) {
                swipe(mOpenScroller.getCurrX(),null);
                postInvalidate();
            }
        } else {
            if (mCloseScroller.computeScrollOffset()) {
                swipe(mBaseX - mCloseScroller.getCurrX(),null);
                postInvalidate();
            }
        }
    }
