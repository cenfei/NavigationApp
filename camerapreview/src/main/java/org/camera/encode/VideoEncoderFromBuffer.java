...
public class  VideoEncoderFromBuffer {
	...
	private static final String DEBUG_FILE_NAME_BASE = "/sdcard/Movies/mp4/";
	private static final String DEBUG_FILE_NAME_BASE_NAME = "1.jpg";
...
//				+ this.mHeight + ".mp4";
		String fileName = DEBUG_FILE_NAME_BASE + CameraSurfaceTextureActivity.mp4FileName+ ".mp4";
