...
public class newSafeQuestionActivity extends BaseActivity {
        ...
        for (Question question : questionList) {
            if (i == 1) {
                ...
                if (answer1 == null || answer1.equals("")) {
                    Util.Toast(newSafeQuestionActivity.this, question.question + "不能为空",null);
                    return;
                } else {
...
//        getQuestionListServerForMsg();
    ...
    protected void initActivityName() {
        activityName = newSafeQuestionActivity.class.getName();
    }
...
//        }
    ...
    public void  setSafePwd() {
        ...
        Util.Toast(newSafeQuestionActivity.this, "请设置提现密码",null);
    ...
    public void updateSafePwdHandler(String resp) {
        ...
        if (resp != null && !resp.equals("")) {
            ...
            if (baseJson.retCode.equals(Constant.RES_SUCCESS)) {
                ...
                Util.startActivity(newSafeQuestionActivity.this, IndexActivity_.class);
...
//                setSafePwd();
                ...
                Util.Toast(this, "安全问题设置成功", new FoxToastInterface.FoxToastCallback() {
                    @Override
                    public void toastCloseCallbak() {
                        finish();
                    }
    ...
    public void getPhoneMsginfoHandler(String resp) {
        foxProgressbarInterface.stopProgressBar();
        if (resp != null && !resp.equals("")) {
            Util.Toast(newSafeQuestionActivity.this, "验证码已发送，注意查收",null);
