...
public class LoadingActivity extends com.yj.navigation.base.BaseActivity {
    ...
    View.OnClickListener startListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (configPref.userToken().get()==null||configPref.userToken().get().equals("")) {
                ...
                Util.startActivityNewTask(LoadingActivity.this, RegActivity_.class);//服务器判断是否有账户
            }else{
                Util.startActivityNewTask(LoadingActivity.this, IndexActivity_.class);//服务器判断是否有账户
