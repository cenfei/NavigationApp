...
public class MyDeviceListActivity extends BaseActivity implements IXListViewListener {
...
//        title.setTextColor(getResources().getColor(R.color.white));
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                // create "open" item
                SwipeMenuItem openItem = new SwipeMenuItem(MyDeviceListActivity.this);
                // set item background
...
//                menu.addMenuItem(deleteItem);
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MyDeviceListActivity.this, position + " long click", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
...
//                Util.startActivity(MyDeviceListActivity.this, MyDeviceListActivity_.class);
    ...
    private void onLoad() {
        mListView.setRefreshTime(RefreshTime.getRefreshTime(MyDeviceListActivity.this));
...
//        }
    ...
    public void getDeviceListFromServerForMsg() {
        ...
        ProtocolUtil.deviceListFunction(MyDeviceListActivity.this, new DeviceListHandler(), configPref.userToken().get());
...
//                    mListView.getRefreshableView().setSelection(y);
    ...
    public void unBindDeviceFromServerForMsg(Integer deviceId) {
        ...
        ProtocolUtil.unbindDeviceFunction(MyDeviceListActivity.this, new UnBindDeviceHandler(), configPref.userToken().get(), deviceId);
