...
//            handler.sendEmptyMessage(0);
        ...
        pullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String bankInfoJson=designRoomInfos.get(position-1);
...
//        foxProgressbarInterface.startProgressBar(MyUpVideoListActivity.this, "加载中...");
//        String beginD = "20161201";
//        String endD = MyStringUtils.getNowTimeFormata(new Date());
//        String params = "0";//0全部 1 审核 2通过
//        Integer rows = 20;
//        ProtocolUtil.mybankListFunction(MyUpVideoListActivity.this, new MyJobListHandler(), configPref.userToken().get());
