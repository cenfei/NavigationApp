...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource) {
        this(context, itemResource, itemTextResource, -1);
    }
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {
                    textView.setBackgroundColor(context.getResources().getColor(R.color.back_fb));
                    textView.setTextColor(context.getResources().getColor(R.color.line_hot_all));

                    textView.setTextSize(maxsize);
                } else {
                    textView.setTextSize(minsize);
                    textView.setTextColor(context.getResources().getColor(R.color.font_titie2));
