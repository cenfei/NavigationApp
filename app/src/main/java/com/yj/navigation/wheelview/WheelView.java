...
package com.yj.navigation.wheelview;
...
import com.yj.navigation.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0x00FFFFFF, 0x00000000, 0x00000000};
        ...
        try {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    //判断是否继续传递信号
                    Log.e("moveTime", moveTime+"moveTime,x:"+moveX+",y"+moveY);
                    ...
                    if(moveTime>200&&(moveX>20||moveY>20)){
                        ...
                        int items = distance / getItemHeight();
                        Log.e("notifyClickListenersAboutClick", "notifyClickListenersAboutClick");
                        notifyClickListenersAboutClick(currentItem + items);
