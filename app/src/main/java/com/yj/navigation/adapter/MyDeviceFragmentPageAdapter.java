...
import com.yj.navigation.fragment.UpdateDeviceFragment;
 ...
 * @author ZHF
 */
public class MyDeviceFragmentPageAdapter extends FragmentPagerAdapter {
    public MyDeviceFragmentPageAdapter(FragmentManager fm) {
        super(fm);
    }
