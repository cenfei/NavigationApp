package com.yj.navigation.wheelviewdialog;
...
import com.yj.navigation.wheelview.OnWheelChangedListener;
import com.yj.navigation.wheelview.OnWheelScrollListener;
import com.yj.navigation.wheelview.WheelView;
import com.yj.navigation.wheelview.adapters.ArrayWheelAdapter;
...
//                Log.e("finish",wheel.getCurrentItem()+"");
        ...
        monthAdapter = new ArrayWheelAdapter<String>(context, arraysinfo, R.id.wheel_text, temp);
