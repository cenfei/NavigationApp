package com.yj.navigation.component;
 ...
 */
public class SZ_PayPopwindow_Common {
     ...
     * 显示popupWindow
     */
    public void showPopwindow(final Activity activity, View relView,String firsttitle,String secondtitle, final CallBackPayWindow callBackPayWindow) {
    ...
    public void initUi(final Activity activity, View view, View relView) {
        ...
        choose_photo_src.setText(firsttitle);
        ...
        choose_photo_lib.setText(secondtitle);
